...
namespace Microcharts
{
    ...
    public class InvalidatedWeakEventHandler<TTarget> : IDisposable where TTarget : class
    {
        ...
        private readonly WeakReference<ChartBase> sourceReference;
        ...
        public bool IsAlive => this.sourceReference.TryGetTarget(out ChartBase s) && this.targetReference.TryGetTarget(out TTarget t);
        ...
        {
            if (!this.isSubscribed && this.sourceReference.TryGetTarget(out ChartBase source))
            {
        ...
        public void Unsubscribe()
        {
            ...
            {
                if (this.sourceReference.TryGetTarget(out ChartBase source))
                {
                    source.Invalidated -= this.OnEvent;
                }
