...
namespace Microsoft.ComponentModelEx.ReactiveData.Sequence.IndexedList
{
    public class IListOnSequence<T> : IIndexedList<T>
    {
        private readonly IList<T> _list;

        public IListOnSequence(IList<T> list)
        {
            _list = list;
        }
